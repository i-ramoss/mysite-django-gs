...
class QuestionModelTests(TestCase):
    def test_was_published_recently_with_future_question(self):
        """
        was_published recently() returns False for question whose pub_date is in the future.
        """
        time = timezone.now() + datetime.timedelta(days=30)
        future_question = Question("test", pub_date=time)

        self.assertIs(future_question.was_published_recently(), False)

    def test_was_published_recently_with_old_question(self):
        """
        was_published_recently() returns False for question whose pub_date is older thant 1 day.
        """
        time = timezone.now() - datetime.timedelta(days=1, seconds=1)
        old_question = Question("test", pub_date=time)
    ...
    def test_was_published_recently_with_recent_question(self):
        ...
        recent_question = Question("test", pub_date=time)
...
class QuestionDetailViewTests(TestCase):
    def test_future_question(self):
        """
        Test detail view of a question with a pub_date in the future returns a 404 not found.
        """
    ...
    def test_past_question(self):
        """
        Test detail view of a question with a pub_date in the past displays the question's text.
        """
